...
export type WidgetPlacement = "hud" | "aboveEditor" | "belowEditor";
...
export interface ExtensionUIContext {
	...
	/** Set a widget in the live HUD, above the editor, or below it. Accepts string array or component factory. */
